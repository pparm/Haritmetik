...
public class KoeTulosIkkuna extends javax.swing.JFrame {
    ...
    public KoeTulosIkkuna(int tehtavaNro,int koeTehtaviaOikein, ArrayDeque<String> vastaustenJonoArrayDeque) {
        //this.vast = vast;
        initComponents();
